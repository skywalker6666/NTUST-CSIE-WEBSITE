...
const BodyContent = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <CarouselBar/>
        <div id="intro" style={{ height: 'auto', padding: '20px', border: '1px solid #ccc' }}>
          <h1>實驗室簡介</h1> 
          <IntroContent />
        </div>     

        <div id="professor" style={{ height: 'auto', padding: '20px', border: '1px solid #ccc' }}>
          <h2>指導老師</h2>
          <ChiaChihContent/>
        </div>

        <div id="publications" style={{ height: 'auto', padding: '20px', border: '1px solid #ccc' }}>
          <h2>研究方向</h2>
          <ResearchContent 
            picture={PUF}
          ...
          <ResearchContent
            ...
            line3="d安全漏洞分析： 研究TEE中可能存在的安全漏洞，以及如何有效地修補這些漏洞。"
        ...
        <div id="members" style={{ height: 'auto', padding: '20px', border: '1px solid #ccc' }}>
          <h2>實驗室成員</h2>
        ...
        <div id="contact" style={{ height: 'auto', padding: '20px', border: '1px solid #ccc' }}>
          <h2>聯絡方式</h2>
          <ContactContent />
        </div>
      </div>
